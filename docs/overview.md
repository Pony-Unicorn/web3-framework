...
- **React Router**: 采用最新的 React Router 的 Framework 模式，仅支持 SSG 和 CSR
...
- **位置**: `app/context/AppKitProvider.tsx`
- **功能**:
...
```bash
# 1. 克隆项目模板
pnpm dlx degit Pony-Unicorn/web3-template my-dapp
